...
3. Select the folder you wish to serve. Choose `/ (root)` if your files are in the main directory.
4. Click **Save**.
...
1. Wait approximately 1–2 minutes for the build to complete.
2. Refresh the **Pages** settings page in your repository.
